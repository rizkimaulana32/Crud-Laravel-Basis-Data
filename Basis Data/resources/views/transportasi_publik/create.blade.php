...
<!-- START FORM -->
@section('konten')
    <form action='{{ url('transportasi_publik') }}' method='post'>
        @csrf
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='ID_Transport' value="{{ Session::get('ID_Transport') }}"
                        id="ID_Transport">
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='Nama_Transport'
                        value="{{ Session::get('Nama_Transport') }}" id="Nama_Transport">
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='Transport_Company'
                        value="{{ Session::get('Transport_Company') }}" id="Transport_Company">
                </div>
            </div>
            <div class="mb-3 row">
