...
<!-- START FORM -->
@section('konten')
    <form action='{{ url('rute/' . $data->ID_Rute) }}' method='post'>
        @csrf
        @method('PUT')
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='Nama_Rute' value="{{ $data->Nama_Rute }}"
                        id="Nama_Rute">
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='Waktu_Berangkat' value="{{ $data->Waktu_Berangkat }}"
                        id="Waktu_Berangkat">
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='Waktu_Tiba' value="{{ $data->Waktu_Tiba }}"
                        id="Waktu_Tiba">
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='IDLokasi_berangkat_ke'
                        value="{{ $data->IDLokasi_berangkat_ke }}" id="IDLokasi_berangkat_ke">
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='IDLokasi_berangkat_dari'
                        value="{{ $data->IDLokasi_berangkat_dari }}" id="IDLokasi_berangkat_dari">
                </div>
            </div>
            <div class="mb-3 row">
